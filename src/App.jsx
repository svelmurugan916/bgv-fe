...
import './App.css';
import { Routes, Route } from 'react-router-dom'; // No need to import 'BrowserRouter as Router' here
...
function App() {
    return (
        <GoogleReCaptchaProvider
            ...
            {/* NotificationProvider should wrap the entire application content */}
            <NotificationProvider>
                <div className="flex min-h-screen bg-[#F8F9FC] font-sans text-slate-700">
                                ...
                                <div className={`flex-grow`}>
                                    <Suspense fallback={<TopBarLoader />}>
                                        <Routes>
                                            ...
                                            <Route
                                                path="/digilocker-verification/:token?"
                                                element={
                                                    <TokenVerifier
                                                        TargetForm={DigiLockerVerificationPage}
                                                        endpoint={VERIFY_DIGI_LOCKER_TOKEN}
                                                        loadingSubtext="Validating Digilocker Link..."
                                                        successMessage="Preparing AADHAAR Identity Check..."
                                                    />
                                                }
                                            />
                    ...
                    {/* NotificationSystem should be a direct child of NotificationProvider */}
                    <NotificationSystem />
                </div>
            </NotificationProvider>
        </GoogleReCaptchaProvider>
