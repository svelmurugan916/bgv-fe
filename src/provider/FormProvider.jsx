...
export const FormProvider = ({ children }) => {
    const [formData, setFormData] = useState({
        ...
        idVerification: {
            ...
            passport_FRONT: { file: null, fileName: '', idNumber: '', dob: '', fileNumber: '', name: '', isExtracted: false },
            passport_BACK: { file: null, fileName: '', idNumber: '', dob: '', fileNumber: '', name: '', isExtracted: false },
            consent: false
        },
        ...
        setFormData(prev => ({
            ...
            idVerification: {
                ...
                pan: {
                    ...
                    idNumber: data.idVerification?.pan?.extractedData?.extractedPiiData || '',
                    fileName: data.idVerification?.pan?.fileName || '',
                    dob: data.idVerification?.pan?.extractedData?.dateOfBirth || '',
                    name: data.idVerification?.pan?.extractedData?.name || '',
                    fileUrl: data.idVerification?.pan?.fileUrl || '',
                    isExtracted: data.idVerification?.pan?.extractedData?.extractedPiiData !== undefined || false,
                    fileId: data.idVerification?.pan?.fileId || '',
                },
                aadhar: {
                    ...prev.idVerification.aadhar,
                    idNumber: data.idVerification?.aadhar?.extractedData?.extractedPiiData || '',
                    fileName: data.idVerification?.aadhar?.fileName || '',
                    dob: data.idVerification?.aadhar?.extractedData?.dateOfBirth || '',
                    name: data.idVerification?.aadhar?.extractedData?.name || '',
                    fileUrl: data.idVerification?.aadhar?.fileUrl || '',
                    isExtracted: data.idVerification?.aadhar?.extractedData?.extractedPiiData !== undefined || false,
                    fileId: data.idVerification?.aadhar?.fileId || '',
                },
                passport_FRONT: {
                    ...prev.idVerification.passport_FRONT,
                    idNumber: data.idVerification?.passport?.extractedData?.FRONT?.passportNumber || '',
                    fileName: data.idVerification?.passport?.fileName || '',
                    dob: data.idVerification?.passport?.extractedData?.FRONT?.dateOfBirth || '',
                    birthPlace: data.idVerification?.passport?.extractedData?.FRONT?.placeOfBirth || '',
                    name: data.idVerification?.passport?.extractedData?.FRONT?.fullName || '',
                    gender: data.idVerification?.passport?.extractedData?.FRONT?.sex || '',
                    fileUrl: data.idVerification?.passport?.fileUrl || '',
                    isExtracted: data.idVerification?.passport?.extractedData?.FRONT?.passportNumber !== undefined || false,
                    fileId: data.idVerification?.passport?.fileId || '',
                    ...data.idVerification?.passport?.extractedData?.FRONT,
                },
                passport_BACK: {
                    ...prev.idVerification.passport_BACK,
                    idNumber: data.idVerification?.passport?.idNumber || '',
                    fileName: data.idVerification?.passport?.fileName || '',
                    dob: data.idVerification?.passport?.dob || '',
                    fileUrl: data.idVerification?.passport?.backFileUrl || '',
                    isExtracted: data.idVerification?.passport?.extractedData?.BACK?.fileNumber !== undefined || false,
                    fileId: data.idVerification?.passport?.backFileId || '',
                    ...data.idVerification?.passport?.extractedData?.BACK,
                },
