import {
    ...
    User, Users, Home, RotateCcwIcon // Added these icons
} from "lucide-react";
...
const AddressVerificationEvidence = ({addressData, setLoading, fetchAddressDetails, addressId, isDrawerOpen}) => {
    ...
    if(addressData?.isFundReleasedOrCancelled) {
        return (
            <div className="flex flex-col items-center animate-in fade-in duration-500 border-2 border-dashed border-slate-200 rounded-[2.5rem] p-12">
                ...
                <p className="text-sm text-slate-500 text-center max-w-[400px] leading-relaxed mb-8">
                    This address check is no longer valid for evaluation because the
                    <span className="font-bold text-slate-700"> reserved funds have been released</span>.
                    Please re-initiate the reservation to proceed with geo-location.
                </p>

                {/* Secondary Action instead of Primary */}
                <button
