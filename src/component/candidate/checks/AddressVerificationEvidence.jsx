...
const AddressVerificationEvidence = ({addressData, setLoading, fetchAddressDetails, addressId}) => {
    ...
    const isLinkResent = (hasCoordinates && addressData.status === 'IN_PROGRESS');
                            ...
                            <>
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 pt-4">
                                    <div className="flex items-center gap-4">
                                        {/* Icon Box: Matches the "Captured Location" style */}
                                        ...
                                        <div>
                                            <div className="flex items-center gap-3">
                                                ...
                                                {/* Status Badge: Matches your "GPS Derived" badge style */}
                                    ...
                                    {/* Signal Accuracy: Minimalist style to match your Top Attribute row */}
