...
const StatsView = ({allOrganizationStatistics, parentDivClass = "max-w-7xl"}) => {
    return (
        <div className={`${parentDivClass} mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 mb-5`} >
            ...
            <div className="bg-white p-6 rounded-3xl border border-slate-100 flex items-center gap-5">
                ...
                <div>
                    ...
                    <p className="text-2xl font-black text-slate-900">{allOrganizationStatistics?.inProgressCases || 0}</p>
                </div>
            </div>
            <div className="bg-white p-6 rounded-3xl border border-slate-100 flex items-center gap-5">
